...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/travels/architecto/tours" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"priceFrom\": 27,
    \"priceTo\": 39,
    \"dateFrom\": \"2026-06-22T15:19:04\",
    \"dateTo\": \"2026-06-22T15:19:04\",
    \"sortBy\": \"price\",
    \"sortOrder\": \"desc\"
}"
</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/travels/architecto/tours"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;No query results for model [App\\Models\\Travel] architecto&quot;
}</code>
 </pre>
    </span>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The slug of the travel. Example: <code>architecto</code></p>
            </div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2026-06-22T15:19:04"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-06-22T15:19:04</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/travels/architecto/tours" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"architecto\",
    \"start_date\": \"2026-06-22T15:19:05\",
    \"ending_date\": \"2027-05-28\",
    \"price\": 4326.41688
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the travel. Example: <code>architecto</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="start_date"                data-endpoint="POSTapi-v1-admin-travels--travel_id--tours"
               value="2026-06-22T15:19:05"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-06-22T15:19:05</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>starting_date</code>. Example: <code>2027-05-28</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    "http://localhost/api/v1/admin/travels/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"is_public\": false,
